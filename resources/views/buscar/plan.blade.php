...
<section class="col-lg-12">
  <section  class="col-lg-4">
    ...
    <center><label  style="padding:1px;text-shadow: black 0.1em 0.1em 0.2em;font-family:'Baloo Bhaina';font-size:15px" >BUSCAR PLAN</label></center></div>
...
<center>
    ...
    <section class="col-lg-11" >
     <select   class="form-control select2 select2-hidden-accessible "data-placeholder="" style="background-color:#605ca8;border-radius:2px" tabindex="-1" aria-hidden="true" id="plan" name="plan">
       <option value=""></option>
...
url='verplan?id={{Session::get('id')}}';
$("#show").load("{!!url('"+url+"')!!}");
};
document.getElementById('ver').onclick = function() {
	ele = document.getElementById("plan").value;
