...
<section class="col-lg-12">
  <section  class="col-lg-6">
    ...
    <center><label  style="padding:1px;text-shadow: black 0.1em 0.1em 0.2em;font-family:'Baloo Bhaina';font-size:15px" >BUSCAR producto</label></center></div>
...
<center>
    ...
    <section class="col-lg-11" >
     <select   class="form-control select2 select2-hidden-accessible "data-placeholder="" style="background-color:#605ca8;border-radius:2px" tabindex="-1" aria-hidden="true" id="producto" name="producto">
       <option value=""></option>
...
url='verproducto?id={{Session::get('id')}}';
$("#show").load("{!!url('"+url+"')!!}");
};
document.getElementById('ver').onclick = function() {
	ele = document.getElementById("producto").value;
	alerta=document.getElementById('alerta');
	alerta.style.display='none';
	element2 = document.getElementById("show");
		url='verproducto?id='+ele;
