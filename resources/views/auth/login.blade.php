...
@endif
<body class="hold-transition login-page" style="background-image: url('img/10.jpg');padding-top:0px">
    <div class="login-box">
        <div class="login-logo" style="padding: 0px;margin: 0px;">
            <a href="{{ url('/home') }}"><img src="img/logo102.png" alt=""></a>
        </div><!-- /.login-logo -->
    ...
    <form action="{{ url('/login') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-xs-12" >
                ...
                style="background-color: rgba(67, 33, 107, 0.7);border-radius: 10px">{{ trans('adminlte_lang::message.buttonsign') }}</button>
            </div><!-- /.col -->
        </div>
    </form>
